 ...
 * Dashboard Page
 *
 * This is the main dashboard page that users see after signing in.
 * It demonstrates authentication checks and role-based content display.
 */
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <h1 className="text-2xl font-bold text-gray-900">BookStock</h1>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg mb-6">
            <div className="px-4 py-5 sm:p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                You are signed in as <strong>{user.email}</strong> with the role of{' '}
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">Active Session</dd>
                    </dl>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">{role_display}</dd>
                    </dl>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Session Type</dt>
                      <dd className="text-lg font-medium text-gray-900">Clerk JWT</dd>
                    </dl>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-500">Manage book inventory</p>
                  </div>
                </a>
